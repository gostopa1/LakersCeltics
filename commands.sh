...
python ./scripts/set_values.py Lakersve/TP1 --offset 5236  --length 24 --values "00"

#3rd stat category
python ./scripts/set_values.py Lakersve/TP5 --offset 5248  --length 24 --values "28"
python ./scripts/set_values.py Lakersve/TP1 --offset 5248  --length 24 --values "08"
...
python ./scripts/visualize_4bit.py Lakersve/TP1 --offset 5224  --lengbth 12 --rows 4 --cols 24 --image ./tests/Celtics_5224-5272.png --overlay
python ./scripts/visualize_4bit.py Lakersve/TP1 --offset 3988  --length 12 --rows 4 --cols 24 --image ./tests/block.png --overlay
